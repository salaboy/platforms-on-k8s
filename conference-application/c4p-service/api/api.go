...
type ServerInterface interface {
	// Get all Proposals
	// (GET /proposals/)
	GetProposals(w http.ResponseWriter, r *http.Request)
	// Create a Proposal
	// (POST /proposals/)
	CreateProposal(w http.ResponseWriter, r *http.Request)
	// Delete a proposal
	// (DELETE /proposals/{proposalId})
	DeleteProposal(w http.ResponseWriter, r *http.Request, proposalId string)
	// Decide a proposal
...
func (siw *ServerInterfaceWrapper) GetProposals(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	var handler http.Handler = http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetProposals(w, r)
	})
...
func (siw *ServerInterfaceWrapper) CreateProposal(w http.ResponseWriter, r *http.Request) {
	...
	var handler http.Handler = http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.CreateProposal(w, r)
	})
...
func (siw *ServerInterfaceWrapper) DeleteProposal(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithLocation("simple", false, "proposalId", runtime.ParamLocationPath, chi.URLParam(r, "proposalId"), &proposalId)
	if err != nil {
	...
	var handler http.Handler = http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.DeleteProposal(w, r, proposalId)
	})
...
// DecideProposal operation middleware
func (siw *ServerInterfaceWrapper) DecideProposal(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	var handler http.Handler = http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.DecideProposal(w, r, proposalId)
	})
