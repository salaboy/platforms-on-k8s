...
// GetAllNotifications operation middleware
func (siw *ServerInterfaceWrapper) GetAllNotifications(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	var handler http.Handler = http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetAllNotifications(w, r)
	})
